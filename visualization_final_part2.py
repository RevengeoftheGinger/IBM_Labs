...
#TASK 2.2: Add two dropdown menus   #Include style for title
app.layout = html.Div([html.H1('Automobile Sales Statistics Dashboard', style={'textAlign': 'center', 'color': '#50ED36', 'font-size': 24}),
...
def update_output_container(input_year, selected_statistics):
    ...
    # Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        ...
        return [html.Div(className='chart-item', children=[html.Div(R_chart1),html.Div(R_chart2)],style={'display': 'flex'}),
